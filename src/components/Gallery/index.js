...
class Gallery extends Component {
  state = {imageURLList: imagesList[0]}

  filteredList = id => {
    const updateImage = imagesList.filter(each => each.id === id)
    this.setState({imageURLList: updateImage[0]})
  }

  render() {
    const {imageURLList} = this.state
    const {id, imageUrl, imageAltText} = imageURLList
    return (
